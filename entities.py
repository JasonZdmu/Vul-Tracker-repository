...
class EnsembleDataset(Dataset):
    def __init__(self, list_IDs, labels, id_to_url, id_to_features, confidences=None):
        self.list_IDs = list_IDs
        self.labels = labels
        self.id_to_url = id_to_url
    ...
    def __getitem__(self, index):
        ...
        if self.confidences is not None:
            confidence = self.confidences[id]
            return int(id), url, feature_1, feature_2, feature_3, feature_5, feature_6, feature_7, feature_8, y, confidence
        else:
